...
void write_vtkPointCoordinates(FILE *fp, int imax, int jmax, double dx,
                               double dy) {
  double originX = 0.0;
  double originY = 0.0;
...
void VTKHelper::printVTKFile(Grid grid, double dx, double dy,
                             std::string casename, std::string outputdir,
                             int timestep, bool temp_flag) {
  ...
  std::string outputname =
      outputdir + '/' + casename + "." + std::to_string(timestep) + ".vtk";
