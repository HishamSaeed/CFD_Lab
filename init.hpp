 ...
 * be set. All the helper operations can be found within helper.hpp and
 * helper.c.
 *
 ...
 */
int read_parameters(std::string szFileName, double *Re, double *PR, double *UI,
                    double *VI, double *PI, double *TI, double *GX, double *GY,
                    double *t_end, double *xlength, double *ylength, double *dt,
                    double *dx, double *dy, int *imax, int *jmax, double *alpha,
                    double *omg, double *tau, int *itermax, double *eps,
                    double *beta, double *dt_value, double *UTop
