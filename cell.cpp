...
Cell::Cell(double &PI, double &UI, double &VI) : _pressure(PI) {
  set_velocity(UI, velocity_type::U);
  set_velocity(VI, velocity_type::V);
};

// Pressure Get and Set
double &Cell::pressure() { return _pressure; }

void Cell::set_pressure(double &value) { _pressure = value; }
...
// Get Flag
int &Cell::flag() { return _flag; };

// Set Flag
void Cell::set_flag(int flag) { _flag = flag; };

// Temperature Get and Set
double &Cell::temperature() { return _temperature; };

void Cell::set_temperature(double &value) { _temperature = value; };
